...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 20, 38, -1, sizeof(::CMsgTEFireBullets)},
};
...
const ::_pbi::DescriptorTable descriptor_table_cs_5fgameevents_2eproto = {
    false, false, 556, descriptor_table_protodef_cs_5fgameevents_2eproto,
    "cs_gameevents.proto",
...
// @@protoc_insertion_point(message_clear_start:CMsgTEFireBullets)
  ...
  if (cached_has_bits & 0x000000fcu) {
    ::memset(&_impl_.mode_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.sound_type_) -
        reinterpret_cast<char*>(&_impl_.mode_)) + sizeof(_impl_.sound_type_));
  }
  if (cached_has_bits & 0x00000f00u) {
    ::memset(&_impl_.item_def_index_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.sound_dsp_effect_) -
        reinterpret_cast<char*>(&_impl_.item_def_index_)) + sizeof(_impl_.sound_dsp_effect_));
...
void CMsgTEFireBullets::InternalSwap(CMsgTEFireBullets* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CMsgTEFireBullets, _impl_.sound_dsp_effect_)
      + sizeof(CMsgTEFireBullets::_impl_.sound_dsp_effect_)
      - PROTOBUF_FIELD_OFFSET(CMsgTEFireBullets, _impl_.origin_)>(
