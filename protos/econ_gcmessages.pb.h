...
constexpr EGCItemMsg EGCItemMsg_MAX = k_EMsgGCRecurringSubscriptionStatus;
...
constexpr EGCItemCustomizationNotification EGCItemCustomizationNotification_MAX = k_EGCItemCustomizationNotification_ClientRedeemMissionReward;
