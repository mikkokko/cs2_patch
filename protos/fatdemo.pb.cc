...
const ::_pbi::DescriptorTable descriptor_table_fatdemo_2eproto = {
    false, false, 1911, descriptor_table_protodef_fatdemo_2eproto,
    "fatdemo.proto",
