...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 72, 81, -1, sizeof(::CMsgSource1LegacyGameEventList_descriptor_t)},
  { 84, 92, -1, sizeof(::CMsgSource1LegacyGameEventList_key_t)},
